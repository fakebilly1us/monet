package com.fakebilly.monet.basic.application.mq.consumer;
...
import com.fakebilly.monet.basic.domain.utils.ApplicationUtil;
...
public class Consumer implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private final static String SERVICE = "basic-service";
