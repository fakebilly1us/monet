...
/**
 * PrometheusApplicationUtil
 * @author FakeBilly
 * @version V1.0.0
 * @github https://github.com/fakebilly1us/monet
 **/
@Component
public class PrometheusApplicationUtil implements ApplicationContextAware {
    ...
    public static <T> T service(Class<T> clazz) {
        ...
        if (!isSpringService) {
            throw new RuntimeException(NOT_SERVICE_MSG);
        }
        return bean(clazz);
    }
    ...
    public static <T> T repository(Class<T> clazz) {
        ...
        if (!isSpringRepository) {
            throw new RuntimeException(NOT_REPO_MSG);
        }
        return bean(clazz);
    }
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        if (PrometheusApplicationUtil.applicationContext == null) {
            PrometheusApplicationUtil.applicationContext = applicationContext;
        }
    }
