package com.fakebilly.monet.es.utils;
...
public class ESApplicationUtil implements ApplicationContextAware {
    ...
    public static <T> T bean(Class<T> clazz) {
        if (applicationContext == null) {
            throw new ElasticSearchException(NOT_EXIST_MSG);
        }
    ...
    public static <T> T service(Class<T> clazz) {
        ...
        if (!isSpringService) {
            throw new ElasticSearchException(NOT_SERVICE_MSG);
        }
        return bean(clazz);
    }
    ...
    public static <T> T repository(Class<T> clazz) {
        ...
        if (!isSpringRepository) {
            throw new ElasticSearchException(NOT_REPO_MSG);
        }
        return bean(clazz);
    }
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        if (ESApplicationUtil.applicationContext == null) {
            ESApplicationUtil.applicationContext = applicationContext;
        }
    }
